...
class EstateProperty(models.Model):
    ...
    def _compute_best_price(self):
        for record in self:
            if record.offer_ids: #<--- sama saja artinya jika record mempunyai offer_ids. Kenapa perlu di buat karna nnati ada kondisi saaat buat data baru dia tidak mempunyai data offer atau blm ada penawaran antar pembeli
